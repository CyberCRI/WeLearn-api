...
expected_output="You must follow the following JSON schema: {json_schema} an entry by document make sure to use double quotes when formating the JSON",
The extracts must be written in lang: {lang}
"""
...
summaries_schema = [
    {
        "summary": "Summary",
        "themes": [
            {"theme": "Theme 1", "reason": "Reason for Theme 1"},
            {"theme": "Theme 2", "reason": "Reason for Theme 2"},
