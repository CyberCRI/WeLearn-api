...
class BamlAsyncClient:
    ...
    async def ChatWithLLM(self, messages: typing.List["types.MyUserMessage"],
        ...
        if 'on_tick' in baml_options:
            ...
            __stream__ = self.stream.ChatWithLLM(messages=messages,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ChatWithLLM", args={
                "messages": messages,
            })
            return typing.cast(types.AgentAnswer, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ChatWithLLM(self, messages: typing.List["types.MyUserMessage"],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.AgentAnswer, types.AgentAnswer]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ChatWithLLM", args={
            "messages": messages,
        })
        return baml_py.BamlStream[stream_types.AgentAnswer, types.AgentAnswer](
          __result__,
          lambda x: typing.cast(stream_types.AgentAnswer, x.cast_to(types, types, stream_types, True, __runtime__)),
          lambda x: typing.cast(types.AgentAnswer, x.cast_to(types, types, stream_types, False, __runtime__)),
          __ctx__,
        )
...
class BamlHttpRequestClient:
    ...
    async def ChatWithLLM(self, messages: typing.List["types.MyUserMessage"],
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ChatWithLLM", args={
            "messages": messages,
        }, mode="request")
        return __result__
    async def ExtractResume(self, resume: str,
