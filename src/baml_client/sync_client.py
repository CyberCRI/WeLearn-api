...
class BamlSyncClient:
    ...
    def ChatWithLLM(self, messages: typing.List["types.MyUserMessage"],
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ChatWithLLM", args={
                "messages": messages,
            })
...
class BamlStreamClient:
    ...
    def ChatWithLLM(self, messages: typing.List["types.MyUserMessage"],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.AgentAnswer, types.AgentAnswer]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ChatWithLLM", args={
            "messages": messages,
        })
        return baml_py.BamlSyncStream[stream_types.AgentAnswer, types.AgentAnswer](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def ChatWithLLM(self, messages: typing.List["types.MyUserMessage"],
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ChatWithLLM", args={
            "messages": messages,
        }, mode="request")
        return __result__
    def ExtractResume(self, resume: str,
