...
class TypeBuilder(type_builder.TypeBuilder):
    def __init__(self):
        super().__init__(classes=set(
          ["AgentAnswer","MyUserMessage","Resume",]
        ), enums=set(
          []
    ...
    @property
    def AgentAnswer(self) -> "AgentAnswerViewer":
        return AgentAnswerViewer(self)
...
class AgentAnswerAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        _tb = tb._tb # type: ignore (we know how to use this private attribute)
        self._bldr = _tb.class_("AgentAnswer")
        self._properties: typing.Set[str] = set([  "answer",  ])
        self._props = AgentAnswerProperties(self._bldr, self._properties)

    def type(self) -> baml_py.FieldType:
        return self._bldr.field()

    @property
    def props(self) -> "AgentAnswerProperties":
        return self._props


class AgentAnswerViewer(AgentAnswerAst):
    def __init__(self, tb: type_builder.TypeBuilder):
        super().__init__(tb)
...
class ResumeAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._properties: typing.Set[str] = set([  "name",  "email",  "experience",  "competencies",  ])
